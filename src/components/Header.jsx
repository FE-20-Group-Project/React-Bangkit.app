  ...
  return (
    <header className='container p-3 mt-5 mb-3'>
        <Row className='header-section d-flex justify-content-around f-wrap'>
            ...
            { isLogin ? (
              <aside>
                  <h1 className='text-header-2'>Selamat Datang Kembali, <span className='text-danger'>{isLogin.name || isLogin.company_name}</span></h1>
                  { isLogin.company_id && (
                    <div className='col-10 col-sm-6'>
                        <Link to='/dashboard' className='w-100'>
                            <button className="learn-more w-100">
                              ...
                              <span className="ms-5 button-text">Lihat Dashboard</span>
                            </button>
                        </Link>
                    </div>
                  ) }
